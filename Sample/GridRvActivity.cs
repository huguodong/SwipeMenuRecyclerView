...
namespace Sample
{
    [Activity(Label = "GridRvActivity")]
    public class GridRvActivity : Activity, SwipeRefreshLayout.IOnRefreshListener
    {
        ...
        public class AppAdapter : RecyclerView.Adapter
        {
            ...
            public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
            {
                ...
                myViewHolder.btGood.Visibility = ViewStates.Gone;
                ...
                myViewHolder.tvSwipeEnable.Visibility = ViewStates.Gone;
            }
